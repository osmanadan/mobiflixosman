    ...
    <>
      <div className="movieplayer">
        ...
        <Player
          ...
          src={
            verificationSkipped
              ? `${'http://192.168.88.9:8080'}${movieDetails!.trailer_url}`
              : `${'http://192.168.88.9:8080'}${movieDetails!.video_url}`
          }
          className="movieplayer-player"
          fluid={false}
          height={250}
          poster={`${movieDetails!.base_url || 'http://192.168.88.9:8080'}${movieDetails!.poster}`}
        >
